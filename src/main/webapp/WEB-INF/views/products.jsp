    ...
    <table class="table">
        ...
        <c:forEach var="item" items="${cart.items}">
            <tr>
                ...
                <td>${item.amount}</td>
                <td><a href="/myshop/addtocart?id=${item.product.id}&category=${id}" class="btn btn-info" role="button">+</a> </td>
                <td><a href="/myshop/removefromcart?id=${item.product.id}&category=${id}" class="btn btn-danger" role="button">-</a> </td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
